...
//    }
    ...
    public void fetchDataFromCloudHistory() {
        ...
        HttpHeaders headers = new HttpHeaders();
        headers.set("Authorization", "version=2022-05-01&res=userid%2F381488&et=1729859380&method=sha1&sign=Fu2qXwhQRoQ00GHGpSkiOxrjN3A%3D");
        headers.set("Accept","application/json, text/plain, */*");
        ...
        if (response.getStatusCode().is2xxSuccessful()) {
            ...
            if (cloudResponse != null && cloudResponse.getData() != null) {
                ...
                record.setCo2_Output(co2Value.multiply(flowValue));
